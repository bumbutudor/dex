...
export default ({ name, className }) => {
  ...
  if (name === 'upload') {
    return (
      <svg id="litera" xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 20 20">
  ...
  if (name === 'reload') {
    return (
      <svg className={className} id="reload-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
